...
struct MathEquations {
    ...
    static func pythagorasTheorum() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Pythagoras's Theorum: ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
        let posttxt = NSAttributedString(string: "      :Pythagoras, 530 BC\n\n", attributes: [NSAttributedStringKey.font: NSFont.systemFont(ofSize: 18)])
...
//        let v : MathExpr = "x"
    ...
    static func logarithms() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Logarithms:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func calculus() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Calculus:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func lawOfGravity() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Law of Gravity:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func rootMinusOne() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "The square root of minus one:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func polyhedra() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Euler's formula for polyhedra:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func normalDistribution() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Normal Distribution:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func waveEquation() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Wave Equation:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func fourierTransform() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Fourier Transform:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func navierStokes() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Navier-Stokes Equation:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func maxwells() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Maxwell's Equations:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func thermo() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Second Law of Thermodynamics:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func relativity() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Relativity:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func schrodinger() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Schrodingers's Equation:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func infoTheory() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Information Theory:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func chaos() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Chaos Theory:      ", attributes: [NSAttributedStringKey.font: NSFont.boldSystemFont(ofSize: 18)])
